...
/**
 * @summary Accessible slider component built on top of Radix primitives.
 * @remarks
 * Mirrors the shadcn/ui slider styling so it can be used across dashboards
 * for granular settings (e.g. language selection sensitivity in the composer).
 */
