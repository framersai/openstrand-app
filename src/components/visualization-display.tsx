              ...
              {visualization.type !== 'table' && (
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-48">
                    <DropdownMenuItem onSelect={(e) => { e.preventDefault(); handleOpenExportWizard(); }}>Export…</DropdownMenuItem>
                    <DropdownMenuItem onSelect={(e) => { e.preventDefault(); handleExportImage(); }}>Quick download (PNG)</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              )}
      ...
      <CardContent>
        ...
        {showExport && (
          <ExportWizard
            ...
            imageDataUrl={exportImageUrl}
            defaultFilename={(visualization.title || 'visualization').replace(/\s+/g, '-')}
          />
        )}
      </CardContent>
    </Card>
