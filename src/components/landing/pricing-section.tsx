  ...
  const tiers: PricingTier[] = [
    {
      ...
      features: [
        ...
        'Local backups & optional Git version control',
    ...
    },
    {
      ...
      features: [
        ...
        'Team storage policy controls (lock/override/opt-out)',
        'S3-compatible mirroring (Linode, AWS, MinIO, Spaces)',
    ...
    },
    {
      ...
      features: [
        ...
        'Advanced cloud storage controls (encryption, lifecycle, versioning)',
