      ...
      <div className="container mx-auto px-4 pb-24">
        <div className="relative overflow-hidden rounded-3xl border border-primary/30 bg-gradient-to-br from-primary/10 via-primary/5 to-secondary/10 p-12 text-center shadow-xl">
          ...
          <div className="relative mx-auto max-w-3xl space-y-6">
            ...
            {mode === 'offline' && (
              <div className="inline-flex items-center gap-3 rounded-full border border-emerald-600/40 bg-emerald-500/15 px-4 py-2 text-sm font-medium text-emerald-800 dark:border-emerald-400/40 dark:bg-emerald-500/20 dark:text-emerald-100">
