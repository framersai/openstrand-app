    ...
    () => [
      {
        ...
        label: 'Recursive strand hierarchies',
        description: 'Scope-safe DAGs with reusable parents per collection',
      },
      {
        icon: PrivacyShieldIcon,
        label: 'Auditable approvals',
        description: 'Request, review, and log every structural change',
      },
      {
        icon: SchemaIntelligenceIcon,
        label: 'AI-suggested placements',
        description: 'Pipeline proposes structure requests automatically',
      },
      {
        icon: LocalFirstIcon,
        label: 'Self-host & offline ready',
        description: 'Run in the cloud or fully offline in minutes',
      },
    ],
    [],
  );
      ...
      <div className="container relative z-10 mx-auto grid gap-16 px-4 pb-20 pt-24 lg:grid-cols-2 lg:items-center">
        ...
        <div className="space-y-8">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground md:text-xl">
            Model recursive hierarchies, route structural requests through approvals, and let visibility cascades keep every scope aligned. OpenStrand makes strand governance practical for both local-first and cloud teams.
            <span className="font-semibold text-foreground"> Free forever. Works offline. No credit card.</span>
          </p>
            ...
            <div className="relative p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-xl border border-cyan-200/30 bg-gradient-to-br from-cyan-50/50 to-white/50 p-4 dark:border-cyan-800/30 dark:from-cyan-950/50 dark:to-gray-900/50">
                  <p className="text-xs text-muted-foreground">Approvals this week</p>
                  ...
                  <p className="mt-1 text-xs text-cyan-600 dark:text-cyan-400">
                    97% resolved inside your SLA windows
                  </p>
                </div>
                <div className="rounded-xl border border-teal-200/30 bg-gradient-to-br from-teal-50/50 to-white/50 p-4 dark:border-teal-800/30 dark:from-teal-950/50 dark:to-gray-900/50">
                  <p className="text-xs text-muted-foreground">Placeholder coverage</p>
                  <p className="text-2xl font-bold text-foreground">
                    <Eye className="mr-1 inline h-5 w-5 text-teal-500" /> 100%
                  </p>
                  <p className="mt-1 text-xs text-teal-600 dark:text-teal-400">
                    Cascades keep every scope audience-safe
                  </p>
                </div>
              </div>
